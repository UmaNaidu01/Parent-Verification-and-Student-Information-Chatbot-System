...
import { Send, Bot, User, Sparkles, GraduationCap, TrendingUp, AlertCircle, Loader2, BookOpen, Mic, MicOff, Languages, Globe } from 'lucide-react';
...
export default function ChatbotAssistant() {
  ...
  const toggleRecording = () => {
    ...
    recognition.onerror = (event) => {
      ...
      setIsRecording(false);
      setMessages(prev => [...prev, { id: Date.now(), text: "Sorry, I couldn't understand. Please try again.", sender: "bot", timestamp: new Date() }]);
    };
