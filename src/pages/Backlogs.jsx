...
export default function Backlogs() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const statusRes = await fetch('/api/v1/student/academic-status', {
  ...
  // Mock backlog details if the backend only provides a number right now
  const backlogDetails = hasBacklogs ? [
    { subject: 'Operating Systems', semester: 'Semester 4', status: 'Not Cleared', examDate: 'May 2026' }
  ] : [];
