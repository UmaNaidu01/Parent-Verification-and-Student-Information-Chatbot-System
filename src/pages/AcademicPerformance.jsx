  ...
  return (
    <div className="space-y-8 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* CGPA Card */}
        <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-3xl p-6 shadow-sm group hover:border-indigo-500/50 transition-all">
        ...
        {/* Subjects Card */}
        <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-3xl p-6 shadow-sm group hover:border-blue-500/50 transition-all">
          <div className="flex items-center gap-4 mb-4">
          ...
          <p className="text-[10px] font-bold text-slate-500">Completed 48 Credits</p>
        </div>

        {/* Strong Subject Card */}
        <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-3xl p-6 shadow-sm group hover:border-emerald-500/50 transition-all">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-black text-slate-900 dark:text-white truncate uppercase">{insights?.strongSubjects?.[0] || 'N/A'}</p>
            </div>
          </div>
        </div>

        {/* Weak Subject Card */}
        <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-3xl p-6 shadow-sm group hover:border-rose-500/50 transition-all">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm font-black text-slate-900 dark:text-white truncate uppercase">{insights?.weakSubjects?.[0] || 'N/A'}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-[2.5rem] p-8 shadow-sm">
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-lg font-black text-slate-900 dark:text-white uppercase tracking-tight">Semester-wise CGPA Trend</h3>
      ...
      <div className="bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-[2.5rem] overflow-hidden shadow-sm">
        <div className="p-8 border-b border-slate-100 dark:border-gray-700 bg-slate-50/50 dark:bg-gray-900/20">
          <div className="flex items-center justify-between">
            ...
            <span className="px-4 py-1.5 bg-indigo-600 rounded-xl text-white text-[10px] font-black uppercase tracking-widest shadow-lg shadow-indigo-600/20">Sem 6 Stats</span>
          </div>
        </div>
