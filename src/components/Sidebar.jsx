...
export default function Sidebar({ isOpen, onClose }) {
  return (
    <>
      ...
      <aside
        className={`fixed top-16 left-0 z-50 h-[calc(100vh-4rem)] w-72 bg-[#0F172A] border-r border-white/5 text-white transition-all duration-300 ease-in-out lg:translate-x-0 ${
              ...
              >
                <div className="flex items-center gap-4">
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all group-hover:scale-110 ${
                    ({ isActive }) => isActive ? "bg-white/20" : "bg-white/5"
                  }`}>
